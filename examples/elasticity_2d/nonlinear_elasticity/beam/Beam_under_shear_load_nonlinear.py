...
from compsim_pinns.hyperelasticity.hyperelasticity_utils import compute_elastic_properties, cauchy_stress_2D, first_piola_stress_tensor_2D
...
def momentum_nonlinear_2d(x, y):
    # calculate strain terms (kinematics)
...
def output_transform(x, y):
    ...
    return bkd.concat([u*x_loc/e_modul, v*(x_loc + y_loc + 1)/e_modul], axis=1)
...
simulation_case = f"Beam_under_shear_load_nonlinear"
