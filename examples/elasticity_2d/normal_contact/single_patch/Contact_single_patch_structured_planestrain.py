...
model_path = (
    ...
    + f"/pretrained_models/elasticity_2d/patch/{method_name}/{method_name}"
)
...
u_x_analytical = -ext_traction / youngs_modulus * nu * (1 + nu) * X[:, 0]
u_y_analytical = ext_traction / youngs_modulus * (1 - nu**2) * X[:, 1]
