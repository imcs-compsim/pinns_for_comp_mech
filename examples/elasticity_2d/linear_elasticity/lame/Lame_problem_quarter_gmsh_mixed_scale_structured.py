"""
Solves a hollow quarter cylinder under internal pressure (Lame problem) using mixed formulation PINNs.

This example demonstrates a physics-informed neural network solving plane strain elasticity
with both displacement and stress as network outputs, enforcing boundary conditions through
