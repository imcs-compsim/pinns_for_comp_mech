...
from compsim_pinns.elasticity.elasticity_utils import problem_parameters, elastic_strain_2d, stress_plane_strain, lin_iso_elasticity_plane_strain
...
def output_transform(x, y):
    ...
    return bkd.concat([u*(x_loc), v*(y_loc), sigma_xx*x_at_l, sigma_yy, sigma_xy*x_loc*y_loc*x_at_l*y_at_h], axis=1)
...
file_path = os.path.join(os.getcwd(), "deep_energy_patch_mixed")
