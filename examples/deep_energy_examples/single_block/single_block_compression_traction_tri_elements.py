...
domain_dimension = 2
quad_rule = GaussQuadratureRule(rule_name="gauss_legendre", element_type="simplex", dimension=domain_dimension, ngp=1) # gauss_legendre gauss_labotto
...
file_path = os.path.join(os.getcwd(), "deep_energy_single_block_compression_traction_tri_elements")
