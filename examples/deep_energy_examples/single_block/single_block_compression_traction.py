"""
Single block compression-traction example using Deep Energy Method.

This module demonstrates the application of Physics-Informed Neural Networks (PINNs)
with the Deep Energy approach to solve a 2D elastic block under compression and traction.
The example uses a variational formulation based on potential energy minimization.

The simulation includes:
- 2D block geometry definition and meshing with Gmsh
- Gaussian quadrature rules for domain and boundary integration
- Deep Energy PDE formulation with custom potential energy function
- Neural network training using the Adam optimizer
- Stress and displacement field predictions
- Analytical solution comparison and error analysis
...
file_path = os.path.join(os.getcwd(), "single_block_compression_traction")
