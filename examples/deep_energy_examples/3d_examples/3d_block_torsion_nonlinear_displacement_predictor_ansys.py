...
displacement_to_4C_save_path = f"{model_path}/3d_block_torsion_nonlinear_displacement_to_4C"
mesh_4C_input_path = str(Path(__file__).parent.parent.parent.parent) + f"/paper-epinn/3d_torsion_prism/block_torsion.exo"
...
for i in range(steps):
    ...
    # matrix market file
    mmwrite(f"{displacement_to_4C_save_path}_{i+1:02}", prediction_4C_points.reshape(-1,1))
