...
Buckling test for a 3D cylinder, done with an incremental approach.
...
from compsim_pinns.hyperelasticity.hyperelasticity_utils import strain_energy_neo_hookean_3d, compute_elastic_properties, cauchy_stress_3D
...
simulation_case = f"3d_cylinder_buckling_force_incremental"
...
for i in range(steps):
    ...
    file_path = os.path.join(model_path, f"{simulation_case}_{int(abs(force_buckling*1E-6)):03}")
