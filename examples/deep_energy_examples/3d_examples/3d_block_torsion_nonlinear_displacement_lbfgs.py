"""
Torsion of a 3D block through a prescribed Dirichlet BC on one end, fixed on
the other end.
...
file_path = os.path.join(os.getcwd(), "3d_block_torsion_nonlinear_displacement_lfbgs")
