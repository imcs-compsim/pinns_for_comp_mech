...
This module implements a Deep Energy-based PINN solver for nonlinear 3D block torsion
problems using incremental loading and L-BFGS optimization. It applies incremental
angular displacement increments to the back face of a block while computing the
stress and displacement fields using Neo-Hookean hyperelasticity.

Key Features:
- 3D hexahedral mesh generation with Gmsh
- Deep Energy approach with strain energy minimization
- Neo-Hookean material model
- Incremental displacement control strategy
- L-BFGS optimization
- VTU output with displacement and stress fields (Cauchy and Piola-Kirchhoff)
...
file_path = os.path.join(
    os.getcwd(), "3d_block_torsion_nonlinear_displacement_incremental_lbfgs"
)
