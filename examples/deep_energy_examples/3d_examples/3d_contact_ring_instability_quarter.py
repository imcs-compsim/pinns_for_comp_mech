...
from utils.geometry.gmsh_models import RingQuarter3D
...
restore_model = False
model_path = str(Path(__file__).parent.parent)+f"/trained_models/3d_contact_ring_instability/3d_contact_ring_instability_quarter_nonlinear"
