...
def output_transform(x, y):
    ...
    return bkd.concat([u*(back_surface)*(front_surface)/e_modul, #displacement in x direction is 0 at x=0
                      v*(back_surface)/e_modul, #displacement in y direction is 0 at y=0
                      w*(back_surface)/e_modul #displacement in z direction is 0 at z=0
                      ], axis=1)
