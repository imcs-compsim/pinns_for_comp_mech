...
restore_model = False
model_path = str(Path(__file__).parent.parent.parent)+f"/pretrained_models/deep_energy_examples/3d_herzian_spherical_contact/3d_herzian_spherical_contact_nonlinear"
