"""
Physics-Informed Neural Network (PINN) for nonlinear beam analysis under shear load.

This module implements a deep energy method using DeepXDE to solve a 2D nonlinear
beam problem under shear loading. It uses a variational approach based on strain
energy minimization with Neo-Hookean hyperelasticity.

The simulation involves:
- Mesh generation via Gmsh for a 2D rectangular beam domain
- Gaussian quadrature integration for energy calculations
- Deep neural network approximation of displacement fields
- Multi-stage training: Adam optimizer followed by L-BFGS optimization
- Post-processing and visualization of displacement and stress fields in VTK format
...
LBFGS_options["iter_per_step"] = 100
LBFGS_options["maxiter"] = 500

model.compile("L-BFGS")
model.train(epochs=stabilization_model_epoch, display_every=100)
