...
file_path = os.path.join(
    os.getcwd(), "deep_energy_hertzian_normal_contact_nonlinear_penalty_small_strain"
)
...
model.compile("adam", lr=0.001)
losshistory, train_state = model.train(
    epochs=1000, callbacks=[epoch_tracker], display_every=100
)
