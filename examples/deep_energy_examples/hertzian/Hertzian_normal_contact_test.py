...
Quarter_Disc = QuarterDisc(radius=radius, center=center, mesh_size=1, angle=255, refine_times=1, gmsh_options=gmsh_options)
...
losshistory, train_state = model.train(epochs=10, callbacks=[epoch_tracker], display_every=1)
