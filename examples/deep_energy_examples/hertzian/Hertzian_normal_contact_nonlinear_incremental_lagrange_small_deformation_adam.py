...
file_path = os.path.join(os.getcwd(), "deep_energy_hertzian_normal_contact_nonlinear_lagrange_small_strain")
epoch_tracker = EpochTracker()
model_saver_incremental = SaveModelVTU(op=cauchy_stress_2D, period=2000, stabilization_epoch=stabilization_model_epoch, filename=file_path)
