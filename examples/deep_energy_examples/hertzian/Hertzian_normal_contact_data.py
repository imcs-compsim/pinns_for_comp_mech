...
if add_external_data:
    ...
    observe_sigma_xx = dde.PointSetOperatorBC(ex_data_xy, ex_data_stress[:,0:1], get_stress_XX)
    observe_sigma_yy = dde.PointSetOperatorBC(ex_data_xy, ex_data_stress[:,1:2], get_stress_YY)
    observe_sigma_xy = dde.PointSetOperatorBC(ex_data_xy, ex_data_stress[:,2:3], get_stress_XY)
