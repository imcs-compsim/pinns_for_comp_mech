...
from utils.elasticity.elasticity_utils import problem_parameters, first_piola_stress_tensor, momentum_mixed_P, problem_parameters, zero_neumann_x_mixed_P_formulation, zero_neumann_y_mixed_P_formulation, cauchy_stress
...
bc1 = dde.OperatorBC(geom, zero_neumann_x_mixed_P_formulation, top_bottom_right)
bc2 = dde.OperatorBC(geom, zero_neumann_y_mixed_P_formulation, top_bottom)
...
data.save(f"Beam2D_mixed_P_{model_complexity}_u_{applied_displacement:.1f}_{activation}_{model_type}.vtu")
