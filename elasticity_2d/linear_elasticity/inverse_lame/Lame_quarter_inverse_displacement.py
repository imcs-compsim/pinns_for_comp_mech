...
from elasticity_utils import stress_plane_stress, momentum_2d_plane_stress, stress_to_traction_2d, zero_neumman_plane_stress_x, zero_neumman_plane_stress_y
...
inv_data = str(Path(__file__).parent)+"/data/lame/Inverse_displacement"
