...
# Contact BC
bc_zero_fisher_burmeister = dde.OperatorBC(
    geom, zero_fisher_burmeister, boundary_circle_contact
)
...
# store the model
model_path = (
    str(Path(__file__).parent.parent.parent) + "/trained_models/hertzian/pure/hertzian"
)
...
file_path = os.path.join(
    os.getcwd(), "Hertzian_normal_contact_fisher_burmeister_w_e3_255"
)
