...
(
    ...
    shear,
    e_modul,
) = problem_parameters()  # with dimensions, will be used for analytical solution
...
file_path = os.path.join(os.getcwd(), "Hertzian_normal_contact_fisher_burmeister_data")
...
x_contact_lim = 2 * np.sqrt(
    2 * radius**2 * abs(ext_traction) * (1 - nu**2) / (e_modul * np.pi)
)
