...
def output_transform(x, y):
    ...
    return bkd.concat([u*(-x_loc)/e_modul, (v*(-y_loc)+applied_disp_y*e_modul)/e_modul], axis=1)
...
file_path = os.path.join(os.getcwd(), "deep_energy_hertzian_normal_contact_nonlinear_displacement")
