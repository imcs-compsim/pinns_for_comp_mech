...
file_path = os.path.join(os.getcwd(), "deep_energy_3d_block_torsion_nonlinear_incremental_lbfgs")
...
losshistory, train_state = model.train(epochs=epochs, callbacks=[epoch_tracker], display_every=1)
